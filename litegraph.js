    ...
    for (var i = 0; i < widgets.length; ++i) {
      ...
      switch (w.type) {
        ...
        case "toggle":
          ...
          else ctx.rect(margin, posY, widget_width - margin * 2, H);
          ctx.fill();
        ...
        case "Add Node":
          LGraphCanvas.onMenuAdd(null, null, e, menu, function (node) {
            ...
            if (
              ...
              return;
            if (
              node_left.outputs[link.origin_slot].type == node.inputs[0].type &&
              node.outputs[0].type == node_right.inputs[0].type
            ) {
